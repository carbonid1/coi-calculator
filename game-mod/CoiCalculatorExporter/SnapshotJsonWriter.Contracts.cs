...
internal static partial class SnapshotJsonWriter
{
    ...
    private static void appendCargoRoute(StringBuilder json, ContractRouteSnapshot route)
    {
        json.Append('{');
        ...
        appendNullableString(json, "contractGameId", route.ContractGameId, true);
        json.Append("\"zones\":[");
        ...
        appendCargoOperationSnapshot(json, route.Operation);
        json.Append('}');
    }
