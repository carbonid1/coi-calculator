...
- Following the user's UI correction, the world-mine summary shows only active mine products, delivery per cycle, and one combined shipping-fuel total. Paused/unrepaired mines, depot cards, raw game statistics, and repeated badges are omitted. The existing Disposal section remains below the summary for dumped-product quantities, including when no world mines are active. Reserves retains draw/growth and runway in production cycles and in-game years. Derived rates remain neutral.
