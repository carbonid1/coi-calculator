...
- Following the user's UI correction, Mines shows only active mine products, delivery per cycle, and one combined shipping-fuel total. Paused/unrepaired mines, depot cards, raw game statistics, repeated badges, and terrain disposal are omitted from this view. Reserves retains draw/growth and runway in production cycles and in-game years. Derived rates remain neutral.
